...
export default function verifyMatchResults(match: MatchInterface, home_team: TournamentTeamInterface, away_team: TournamentTeamInterface, victory_points: number, draw_points: number, lose_points: number) {
    ...
    home_team.ultilization_rate = Math.floor(home_team.points / (home_team.matches_played * 3) * 100);
    away_team.ultilization_rate = Math.floor(away_team.points / (away_team.matches_played * 3) * 100);
